...
import { annualIncome, quarterlyKPIs, annualFCF, headcount } from '../data/spotify'
  ...
  return (
    <section id="evidence" className="section">
      ...
      <div ref={header.ref} className={`reveal${header.vis ? ' visible' : ''}`} style={{ marginBottom: 56 }}>
        <div className="act-badge">Act 03</div>
        <h2 className="section-title">The Evidence</h2>
        <p className="section-sub">
          From loss-making growth machine to cash-generating platform. The numbers tell the story —
          here's how Spotify's decade of investments compounded into structural profitability.
        </p>
      </div>
